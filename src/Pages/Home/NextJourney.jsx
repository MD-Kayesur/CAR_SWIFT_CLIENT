...
const [ref, isVisible] = useMovementHook();
    return (
        ...
        <div className="hero-content text-neutral-content text-center">
          <div className="hero    ">
            <div ref={ref}  className=  {`hero-content flex-col md:relative  lg:flex-row ${isVisible ? "movement" : ""}`}>
              ...
              <div ref={ref}  className={`text-left flex-1/2 bg-gradient-to-r from-purple-500 to-blue-500 text-white p-10 rounded-3xl ${isVisible ? "movement" : ""}`} >
